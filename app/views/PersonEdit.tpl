...
<form action="{$cfg->action_root}personSave" method="post" class="pure-form pure-form-aligned">
	<fieldset>
		...
		<div class="pure-controls">
			...
			<a class="pure-button button-secondary" href="{$cfg->action_root}personList">Powrót</a>
		</div>
	</fieldset>
